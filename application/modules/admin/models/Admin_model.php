...
class Admin_model extends Ci_Model {
    ...
    /**
     * 
     * @param string $table is Name of table to update
     * @param array $data is associative array of form data to update
     * @param array $id is row id.
     */
    function updateByIdGolbal($table, $data, $id) {
